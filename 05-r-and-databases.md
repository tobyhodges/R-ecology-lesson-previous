...
``` output
#> src:  sqlite 3.47.1 [/home/runner/work/R-ecology-lesson-previous/R-ecology-lesson-previous/site/built/data_raw/portal_mammals.sqlite]
...
``` output
#> # Source:   SQL [?? x 9]
#> # Database: sqlite 3.47.1 [/home/runner/work/R-ecology-lesson-previous/R-ecology-lesson-previous/site/built/data_raw/portal_mammals.sqlite]
...
``` output
#> src:  sqlite 3.47.1 [/home/runner/work/R-ecology-lesson-previous/R-ecology-lesson-previous/site/built/data/portal-database-output.sqlite]
#> tbls:
```
